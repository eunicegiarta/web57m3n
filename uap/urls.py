...
urlpatterns = patterns('',
   ...
   # url(r'^signup/coach/$', 'uap_app.views.basecase_signup_coach' ),
    ...
    url(r'^tutee/home/success$', 'uap_app.views.home_success_tutee' ),
    ...
    url(r'^coach/submit_meeting_details/request_(?P<pid>\d+)$', 'uap_app.views.submit_mtg_details'),
